...
public class LocalDateExpressionImpl extends ComparableExpressionImpl<LocalDate> implements LocalDateExpression
{
    ...
    /* (non-Javadoc)
     * @see org.datanucleus.store.types.jdo.query.LocalDateExpression#getDayOfMonth()
     */
    ...
    /* (non-Javadoc)
     * @see org.datanucleus.store.types.jdo.query.LocalDateExpression#getMonthValue()
     */
    ...
    /* (non-Javadoc)
     * @see org.datanucleus.store.types.jdo.query.LocalDateExpression#getYear()
     */
