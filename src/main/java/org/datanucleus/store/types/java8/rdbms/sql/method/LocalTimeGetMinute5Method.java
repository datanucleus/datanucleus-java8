...
/**
 * Method for evaluating {localtimeExpr}.getMinute() using SQLite.
 * Returns a NumericExpression that equates to <pre>strftime("%M", expr)</pre>
 */
public class LocalTimeGetMinute5Method extends AbstractSQLMethod
{
    /* (non-Javadoc)
