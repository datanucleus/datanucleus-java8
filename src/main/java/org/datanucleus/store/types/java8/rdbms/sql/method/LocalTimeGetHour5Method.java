...
/**
 * Method for evaluating {localtimeExpr}.getHour() using SQLite.
 * Returns a NumericExpression that equates to <pre>strftime("%H", expr)</pre>
 */
public class LocalTimeGetHour5Method extends AbstractSQLMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        SQLExpression hh = exprFactory.newLiteral(stmt, mapping, "%H");
