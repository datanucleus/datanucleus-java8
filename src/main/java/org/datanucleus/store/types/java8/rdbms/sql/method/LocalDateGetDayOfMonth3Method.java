...
/**
 * Method for evaluating {localdateExpr}.getDayOfMonth() using PostgreSQL.
 * Returns a NumericExpression that equates to <pre>date_part("day", expr)</pre>
 */
public class LocalDateGetDayOfMonth3Method extends AbstractSQLMethod
{
    /* (non-Javadoc)
