...
/**
 * Method for evaluating {localdateExpr}.getYear() using SQLite.
 * Returns a NumericExpression that equates to <pre>strftime("%Y", expr)</pre>
 */
public class LocalDateGetYear4Method extends AbstractSQLMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        SQLExpression day = exprFactory.newLiteral(stmt, mapping, "%Y");
