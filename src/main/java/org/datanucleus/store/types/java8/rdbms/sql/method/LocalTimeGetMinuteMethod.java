...
/**
 * Method for evaluating {localtimeExpr}.getMinute().
 * Returns a NumericExpression that equates to <pre>MINUTE(dateExpr)</pre>
 */
public class LocalTimeGetMinuteMethod extends AbstractSQLMethod
{
    /* (non-Javadoc)
