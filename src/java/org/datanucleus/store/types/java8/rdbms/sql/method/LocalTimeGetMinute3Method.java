...
/**
 * Method for evaluating {localtimeExpr}.getMinute() using PostgreSQL.
 * Returns a NumericExpression that equates to <pre>date_part("minute", expr)</pre>
 */
public class LocalTimeGetMinute3Method extends AbstractSQLMethod
{
    /* (non-Javadoc)
